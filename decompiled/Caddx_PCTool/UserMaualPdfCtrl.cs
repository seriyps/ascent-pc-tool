...
public class UserMaualPdfCtrl : UserControl, IDisposable
{
	...
	private void LoadPDF(string name)
	{
		...
		try
		{
			FileStream fileStream = File.OpenRead(_devname switch
			{
				"Ascent Goggles" => ConstVal.ASCENT_GOGGLES_Path, 
				"Ascent\u00a0Lite\u00a0VTX" => ConstVal.ASCENT_LITEVTX_Path, 
				"Ascent VRX" => ConstVal.ASCENT_VRX_Path, 
				"Ascent GT PRO" => ConstVal.ASCENT_GTPRO_Path, 
				_ => ConstVal.ASCENT_GOGGLES_Path, 
			});
