...
{
	private string lab_title_cn = "联系我们";

	private string lab_desc_cn = "我们的团队都随时准备为您提供支持。 选择以下任意方式与我们取得联系：";

	private string lab_qqGroup_cn = "QQ群联系";

	private string lab_qqGDesc_cn = "加入我们的QQ群：与我们团队实时沟通，获取更多信息。";

	private string lab_email_cn = "邮件联系";

	private string lab_emailDesc_cn = "发送邮件给我们客服：我们会在24小时内回复。";

	private string lab_Wechat_cn = "客服企业微信";

	private string lab_WechatDesc_cn = "联系客服企业微信：通过企业微信与我们取得联系，我们会尽快回复您。";

	private string lab_title_en = "Contact Us";

	private string lab_desc_en = "Our team is always ready to support you. Contact us using any of the following methods:";

	private string lab_qqGroup_en = "QQ group contact";

	private string lab_qqGDesc_en = "Join our QQ group: Communicate with our team in real time and get more information.";

	private string lab_email_en = "Email Contact";

	private string lab_emailDesc_en = "Email our customer service: We'll respond within 24 hours.";

	private string lab_Wechat_en = "Customer Enterprise WeChat";

	private string lab_WechatDesc_en = "Contact us via WeChat:We will respond to you as soon as possible.";
	...
	private void InitializeComponent()
	{
		...
		((Control)stackPanel1).Controls.Add((Control)(object)lab_QQGNum2);
		((Control)stackPanel1).Controls.Add((Control)(object)lab_QQGNum);
