...
public class SplashScreen : Form
{
	...
	private static ShowLogoStatus _logoSta;
	...
	public SplashScreen()
	{
		...
		((Form)this)._002Ector();
		InitializeComponent();
		((Form)this).Size = new Size((int)((double)((Control)this).BackgroundImage.Size.Width / 1.5), (int)((double)((Control)this).BackgroundImage.Height / 1.5));
		((Form)this).Opacity = 0.0;
		UpdateTimer.Interval = 50;
		UpdateTimer.Start();
		((Form)this).ClientSize = new Size((int)((double)((Control)this).BackgroundImage.Size.Width / 1.5), (int)((double)((Control)this).BackgroundImage.Height / 1.5));
		((Control)label1).Font = new Font(((FontCollection)GD.Inst.TitlePFC).Families[0], 42f);
		...
		case ShowLogoStatus.company:
			...
			break;
		default:
			((IControl)label1).Visible = false;
			pictureBox1.Image = (Image)(object)Resources.neutralLogo;
			break;
		}
	}

	public static void ShowSplashScreen(ShowLogoStatus logoSt)
	{
		...
		if (!m_bFirstLaunch && m_dblLastCompletionFraction < m_dblCompletionFraction)
		{
			...
			if (num > 0 && height > 0)
			{
				...
				if (!((Control)pnlStatus).IsDisposed)
				{
					...
					LinearGradientBrush val2 = new LinearGradientBrush(m_rProgress, Color.FromArgb(58, 96, 151), Color.FromArgb(181, 237, 254), (LinearGradientMode)0);
	...
	{
		int x = (Screen.PrimaryScreen.Bounds.Size.Width - 800) / 2;
		int y = (Screen.PrimaryScreen.Bounds.Size.Height - 600) / 2;
		((Form)this).Location = new Point(x, y);
		((Form)this).Size = new Size(800, 600);
	}
	...
	private void InitializeComponent()
	{
		...
		((Control)lblStatus).Font = new Font("阿里巴巴普惠体", 15.75f, (FontStyle)0, (GraphicsUnit)3, (byte)134);
		...
		((Control)lblTimeRemaining).Font = new Font("阿里巴巴普惠体", 15.75f, (FontStyle)0, (GraphicsUnit)3, (byte)134);
		...
		pictureBox1.Image = (Image)(object)Resources.new_Logo;
		((Control)pictureBox1).Location = new Point(304, 120);
		((Control)pictureBox1).Margin = new Padding(0);
		((Control)pictureBox1).Name = "pictureBox1";
		((Control)pictureBox1).Size = new Size(220, 190);
		...
		((Control)label1).Font = new Font("阿里巴巴普惠体", 42f, (FontStyle)0, (GraphicsUnit)3, (byte)238);
		((Control)label1).Location = new Point(216, 313);
		((Control)label1).Name = "label1";
		((Control)label1).Size = new Size(376, 77);
		((Control)label1).TabIndex = 4;
		((Control)label1).Text = "Caddx PC Tool";
		((Form)this).AutoScaleBaseSize = new Size(6, 14);
		((Control)this).BackColor = Color.White;
		((Control)this).BackgroundImage = (Image)(object)Resources.bg;
